{
	...
	function emailCheck() {
	    ...
	    if (/^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$/.test(email)) {
	        emailMessage.innerHTML = "<font color='green'>올바른 이메일 형식입니다.</font>";
			return true;
	    } else {
	...
	function nickCheck() {
		  ...
		  fetch(`checkNickname.jsp?userNick=${nickname}`)
		          ...
		          .then(data => {
		              if (data.trim() === "available") {
						  ...
						  console.log("닉네임 사용불가");
						  isNickAvailable=false; //사용 불가
		              }
					  console.log("닉네임 중복검사완료");
		  ...
		  function submitUpdateForm() {
			  ...
			  //닉네임 중복 검사 결과 확인
			  if(!isNickAvailable||!isNickChecked){
